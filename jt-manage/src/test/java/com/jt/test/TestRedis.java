...
public class TestRedis {
    ...
    public void testShards(){
        ...
        shards.add(new JedisShardInfo("192.168.189.130",6379));
        shards.add(new JedisShardInfo("192.168.189.130",6380));
        shards.add(new JedisShardInfo("192.168.189.130",6381));
        //准备分片对象
    ...
    public void testCluster(){
        ...
        nodes.add(new HostAndPort("192.168.189.130", 7000));
        nodes.add(new HostAndPort("192.168.189.130", 7001));
        nodes.add(new HostAndPort("192.168.189.130", 7002));
        nodes.add(new HostAndPort("192.168.189.130", 7003));
        nodes.add(new HostAndPort("192.168.189.130", 7004));
        nodes.add(new HostAndPort("192.168.189.130", 7005));
